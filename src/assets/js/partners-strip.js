(function () {
  ...
  function lockPageHorizontal() {
    ...
    pageLocked = true;
    document.documentElement.classList.add('pk-partners-x-lock');
  }

  function unlockPageHorizontal() {
    if (!pageLocked) return;
    pageLocked = false;
    document.documentElement.classList.remove('pk-partners-x-lock');
  }
